...
- **Status Management:** Update order status (e.g., _Food Preparing_, _Out for Delivery_) via a dedicated **PATCH** endpoint.
...
![System Architecture Diagram](./docs/Dataflow_diagram.png)
